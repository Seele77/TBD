...
class FlashVidConfig:
    ...
    # Runtime toggles for dual-path training.
    enabled: bool = field(default=True)
    enable_visual_compression: bool = field(default=True)
    enable_llm_compression: bool = field(default=False)
    return_compression_metadata: bool = field(default=False)
