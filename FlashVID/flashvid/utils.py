...
def flashvid_compression(
    ...
    if return_metadata:
        metadata = {
            ...
            "keep_visual_indices": final_global_indices[sorted_indices].detach(),
            "num_frames": num_frames,
            "num_visual_tokens": num_visual_tokens,
            "retained_token_count": sorted_tokens.shape[0],
        }
        return sorted_tokens, final_global_indices[sorted_indices], metadata
